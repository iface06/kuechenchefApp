...
public class SpeiseplanDruckerTest {
    ...
    private Tag createTag(int tags) {
        Tag tag = new Tag(tags);
        Speise speise1 = createSpeise(tags, "Beliebteste Speise");
        tag.setBeliebtesteSpeise(speise1);
        Speise speise2 = createSpeise(tags, "Zweitbeliebteste Speise");
        tag.setZweitbeliebtesteSpeise(speise2);
        Speise speise3 = createSpeise(tags, "Drittbeliebteste Speise");
        tag.setDrittbeliebtesteSpeise(speise3);
        return tag;
    }

    private Speise createSpeise(int tags, String name) {
        Speise speise1 = new Speise();
        speise1.setName(name + " " +tags);
        return speise1;
    }
}
